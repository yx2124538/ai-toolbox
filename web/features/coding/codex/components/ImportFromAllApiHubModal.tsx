...
import {
  listCodexAllApiHubProviders,
  resolveCodexAllApiHubProviders,
...
const SUPPORTED_PROVIDER_TYPES = ['@ai-sdk/openai', '@ai-sdk/openai-compatible'];
...
const ImportFromAllApiHubModal: React.FC<Props> = ({
  ...
  return (
    <ImportFromAllApiHubModalBase
      ...
      listProviders={listCodexAllApiHubProviders}
      resolveProviders={resolveCodexAllApiHubProviders}
      onCancel={onCancel}
      onImport={onImport}
      texts={texts}
